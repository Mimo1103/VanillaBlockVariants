package net.mim0.vanillavariants.creativemodetab;
...
public class ModCreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, VanillaVariants.MODID);

    public static final Supplier<CreativeModeTab> VANILLA_VARIANTS_TAB = CREATIVE_MODE_TABS.register("vanilla_variants_tab",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable("creativemodetab.vanillavariants"))
