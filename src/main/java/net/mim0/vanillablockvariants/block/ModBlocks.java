package net.mim0.vanillablockvariants.block;

import net.mim0.vanillablockvariants.VanillaBlockVariants;
import net.mim0.vanillablockvariants.item.ModItems;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(VanillaBlockVariants.MODID);
    ...
    public static final DeferredBlock<Block> AMETHYST_WALL = registerBlock("amethyst_wall",
            properties -> new WallBlock(Blocks.AMETHYST_BLOCK.properties()));
    public static final DeferredBlock<Block> AMETHYST_STAIRS = registerBlock("amethyst_stairs",
            properties -> new StairBlock(Blocks.AMETHYST_BLOCK.defaultBlockState(),
                    Blocks.AMETHYST_BLOCK.properties()));
    public static final DeferredBlock<Block> AMETHYST_SLAB = registerBlock("amethyst_slab",
            properties -> new SlabBlock(Blocks.AMETHYST_BLOCK.properties()));

    public static final DeferredBlock<Block> COAL_WALL = registerBlock("coal_wall",
            properties -> new WallBlock(Blocks.COAL_BLOCK.properties()));
    public static final DeferredBlock<Block> COAL_STAIRS = registerBlock("coal_stairs",
            properties -> new StairBlock(Blocks.COAL_BLOCK.defaultBlockState(),
                    Blocks.COAL_BLOCK.properties()));
    public static final DeferredBlock<Block> COAL_SLAB = registerBlock("coal_slab",
            properties -> new SlabBlock(Blocks.COAL_BLOCK.properties()));

    public static final DeferredBlock<Block> IRON_WALL = registerBlock("iron_wall",
            properties -> new WallBlock(Blocks.IRON_BLOCK.properties()));
    public static final DeferredBlock<Block> IRON_STAIRS = registerBlock("iron_stairs",
            properties -> new StairBlock(Blocks.IRON_BLOCK.defaultBlockState(),
                    Blocks.IRON_BLOCK.properties()));
    public static final DeferredBlock<Block> IRON_SLAB = registerBlock("iron_slab",
            properties -> new SlabBlock(Blocks.IRON_BLOCK.properties()));

    public static final DeferredBlock<Block> GOLD_WALL = registerBlock("gold_wall",
            properties -> new WallBlock(Blocks.GOLD_BLOCK.properties()));
    public static final DeferredBlock<Block> GOLD_STAIRS = registerBlock("gold_stairs",
            properties -> new StairBlock(Blocks.GOLD_BLOCK.defaultBlockState(),
                    Blocks.GOLD_BLOCK.properties()));
    public static final DeferredBlock<Block> GOLD_SLAB = registerBlock("gold_slab",
            properties -> new SlabBlock(Blocks.GOLD_BLOCK.properties()));

    public static final DeferredBlock<Block> EMERALD_WALL = registerBlock("emerald_wall",
            properties -> new WallBlock(Blocks.EMERALD_BLOCK.properties()));
    public static final DeferredBlock<Block> EMERALD_STAIRS = registerBlock("emerald_stairs",
            properties -> new StairBlock(Blocks.EMERALD_BLOCK.defaultBlockState(),
                    Blocks.EMERALD_BLOCK.properties()));
    public static final DeferredBlock<Block> EMERALD_SLAB = registerBlock("emerald_slab",
            properties -> new SlabBlock(Blocks.EMERALD_BLOCK.properties()));

    public static final DeferredBlock<Block> DIAMOND_WALL = registerBlock("diamond_wall",
            properties -> new WallBlock(Blocks.DIAMOND_BLOCK.properties()));
    public static final DeferredBlock<Block> DIAMOND_STAIRS = registerBlock("diamond_stairs",
            properties -> new StairBlock(Blocks.DIAMOND_BLOCK.defaultBlockState(),
                    Blocks.DIAMOND_BLOCK.properties()));
    public static final DeferredBlock<Block> DIAMOND_SLAB = registerBlock("diamond_slab",
            properties -> new SlabBlock(Blocks.DIAMOND_BLOCK.properties()));

    public static final DeferredBlock<Block> NETHERITE_WALL = registerBlock("netherite_wall",
            properties -> new WallBlock(Blocks.NETHERITE_BLOCK.properties()));
    public static final DeferredBlock<Block> NETHERITE_STAIRS = registerBlock("netherite_stairs",
            properties -> new StairBlock(Blocks.NETHERITE_BLOCK.defaultBlockState(),
                    Blocks.NETHERITE_BLOCK.properties()));
    public static final DeferredBlock<Block> NETHERITE_SLAB = registerBlock("netherite_slab",
            properties -> new SlabBlock(Blocks.NETHERITE_BLOCK.properties()));
