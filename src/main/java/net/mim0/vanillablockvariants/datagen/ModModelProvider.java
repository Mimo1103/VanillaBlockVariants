...
public class ModModelProvider extends ModelProvider {
    public ModModelProvider(PackOutput output) {
        super(output, VanillaBlockVariants.MODID);
    }
    ...
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        blockModels.family(Blocks.AMETHYST_BLOCK)
                .wall(ModBlocks.AMETHYST_WALL.get())
                .stairs(ModBlocks.AMETHYST_STAIRS.get())
                .slab(ModBlocks.AMETHYST_SLAB.get());

        blockModels.family(Blocks.COAL_BLOCK)
                .wall(ModBlocks.COAL_WALL.get())
                .stairs(ModBlocks.COAL_STAIRS.get())
                .slab(ModBlocks.COAL_SLAB.get());

        blockModels.family(Blocks.IRON_BLOCK)
                .wall(ModBlocks.IRON_WALL.get())
                .stairs(ModBlocks.IRON_STAIRS.get())
                .slab(ModBlocks.IRON_SLAB.get());

        blockModels.family(Blocks.GOLD_BLOCK)
                .wall(ModBlocks.GOLD_WALL.get())
                .stairs(ModBlocks.GOLD_STAIRS.get())
                .slab(ModBlocks.GOLD_SLAB.get());

        blockModels.family(Blocks.EMERALD_BLOCK)
                .wall(ModBlocks.EMERALD_WALL.get())
                .stairs(ModBlocks.EMERALD_STAIRS.get())
                .slab(ModBlocks.EMERALD_SLAB.get());

        blockModels.family(Blocks.DIAMOND_BLOCK)
                .wall(ModBlocks.DIAMOND_WALL.get())
                .stairs(ModBlocks.DIAMOND_STAIRS.get())
                .slab(ModBlocks.DIAMOND_SLAB.get());

        blockModels.family(Blocks.NETHERITE_BLOCK)
                .wall(ModBlocks.NETHERITE_WALL.get())
                .stairs(ModBlocks.NETHERITE_STAIRS.get())
                .slab(ModBlocks.NETHERITE_SLAB.get());
